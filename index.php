...
Website: https://jcesarg.github.io/personal/
-->
...
<head>
	<title>Magy Tarot - El poder del Tarot en tu vida</title>
	<meta charset="utf-8">
	<meta content="width=device-width, initial-scale=1.0" name="viewport">
	<meta name="description" content="Magy Tarot - El poder del Tarot en tu vida">
	<meta name="keywords" content="astrologia, lectura de cartas, tarot, luna, signos zodiacales, horoscopos, cartas, numerologia, zodiaco, lectura de cartas Puebla, lectura de cartas Querétaro, lectura de cartas Veracruz, lectura de cartas CDMX">
	<meta name="author" content="Julio César">
	<meta name="MobileOptimized" content="320">
	<meta name=distribution content=global>

	<meta name=revisit content="3 days">
	<meta name=copyright content=www.magytarot.mx>
	<meta name=author content="Magy Tarot - El poder del Tarot en tu vida">
	<meta name=doc-rights content="Magy Tarot - El poder del Tarot en tu vida">
	<meta name=doc-publisher content="Magy Tarot - El poder del Tarot en tu vida">
	<meta property=og:title content="El poder del Tarot en tu vidal"/>
	<meta property=og:url content="https://magytarot.mx/"/>
	<meta property=og:site_name content="Magy Tarot"/>
	<meta name="DC.title" content="Magy Tarot" />
	...
	<script src="https://kit.fontawesome.com/41d9535539.js" crossorigin="anonymous"></script>
	<!-- Favicon Link -->
...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-3 col-10">
					<div class="ast_logo">
						<a href="https://magytarot.mx/"><img src="images/header/logo.svg" alt="Logo" title="Logo"></a>
					</div>
				</div>
				<div class="col-lg-9 col-md-9 col-sm-9 col-2">
					<div class="ast_main_menu_wrapper">
						<div class="ast_menu">
							<ul>
								<li><a href="#el_tarot">El Tarot</a></li>
								<li><a href="#magy_tarot">Quien Soy</a></li>
		...
		<div class="ast_banner_text">
			...
			<div class="container">
				<div class="ast_bannertext_wrapper">
					<!--<h1>El poder del Tarot en tu vida</h1>-->
					<ul class="ast_toppadder40 ast_bottompadder50">
						<li>Cartas</li>
						<li>Signos</li>
						<li>Sesiones</li>
					</ul>
					<a href="tel:+5215515249681" class="ast_btn"><i class="fas fa-phone-alt"></i> Llámame</a>
				</div>
				<div class="ast_footer_info">
					<br>
					<ul>
						<li><a href="https://www.facebook.com/profile.php?id=100093455847644&mibextid=JRoKGi" target="_blank"><i class="fab fa-facebook"></i></a></li>
						<li><a href="#" target="_blank"><i class="fab fa-instagram"></i></a></li>
						<li><a href="https://www.tiktok.com/@magy.tarot" target="_blank"><i class="fab fa-tiktok"></i></a></li>
					</ul>
				</div>
			</div>
		</div>
	...
	<!-- El tarot Start -->
	<div class="ast_about_wrapper gray_wrapper ast_toppadder90 ast_bottompadder70" id="el_tarot">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="ast_heading">
						<h1>El poder del <span>Tarot</span> en tu vida.</h1>
					</div>
				</div>
				<div class="col-lg-6 col-md-12 col-sm-12 col-12">
					<div class="ast_about_info_img">
						<div class="about_slider slider_half">
							<div class="card c" id="first"><img src="images/content/about01.jpg" alt=""
									class="img-responsive"></div>
							<div class="card a" id="second"><img src="images/content/about02.jpg" alt=""
									class="img-responsive"></div>
				...
				<div class="col-lg-6 col-md-12 col-sm-12 col-12">
					<div class="ast_about_info">
						<p>El tarot es un lenguaje, cada carta es una palabra, un sustantivo o un verbo. Al combinar las cartas podemos leer relatos diferentes y concretos. El tarot nos brinda respuestas a los problemas que enfrentamos cada día., y nos da la posibilidad (si queremos), de construir la vida que deseamos.</p>
						<p>Arquetipos maravillosos que representan las mas puras expresiones del ser humano., es una simbología profunda hacia la evolución del ser humano para crear conciencia sobre nuestra propia vida.</p>
						<center>
							<h4><i><b>Nosce te ipsum et nosces universum et deos”.</b></i></h4>
							<small>(Conócete a ti mismo, y conocerás el universo y lo divino).</small>
						</center>
					</div>
				</div>
			</div>
	...
	<!-- Magy Tarot Start -->
	<div class="ast_about_wrapper ast_toppadder70 ast_bottompadder70" id="magy_tarot">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="ast_heading">
						<h1>Quien es <span>Magy Tarot</span></h1>
					</div>
				</div>
				<div class="col-lg-7 col-md-12 col-sm-12 col-12">
					<div class="ast_about_info">
						<p>Los comienzos son por casualidad o causalidad, una tarde al salir del colegio una carta callo a mis pies… era El Mago, el arcano mayor N.2, yo sin saber aún que era el tarot, y mucho menos saber que  aquella carta simbolizaba el inicio, radiante, arriesgado e impaciente, el arcano curioso que te invita a ser tú mismo.</p>
						<p>El camino estaba marcado, aunque para ese entonces yo solo alcanzaba a maravillarse con los colores y las imágenes ilegibles que componían aquella carta que yo guardaba bajo mi almohada como un bendito presente.</p>
						<p>La respuesta a lo que tenía en mis manos y miraba cada noche antes de dormir, llego una tarde de abril con los ojos abiertos e infinitos de mi abuela al saber de dónde había venido esa carta hasta mis pies. Ella me enseño lo que era el tarot, lo que suponía su llegada a mi vida y el placer de una mujer mayor al compartir conmigo su más grande y escondido don. Gracias abuela.</p>
						<p>Han pasado 30 años desde ese momento, años en los que la fui desarrollando mi capacidad de interpretación y absorción de conocimientos que hoy me conceden el placer de ayudar y brindar mi servicio a miles de personas que buscan una guía, una respuesta.</p>
						<center><a href="tel:+5215515249681" style="font-size:3em;" class="animate-charcter"><i
									class="fas fa-phone-alt"></i> Llámame</a></center>
					</div>
				</div>
				<div class="col-lg-5 col-md-12 col-sm-12 col-12">
					<div class="ast_about_info_img">
						<img src="images/content/magy.png" alt="About">
					</div>
				</div>
			</div>
		</div>
	...
	<!-- Sesiones Start -->
	<div class="ast_vastu_wrapper ast_toppadder70 ast_bottompadder70" id="sesiones">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="ast_heading">
						<h1>¿Qué puedes esperar de una<br><span>sesión personalizada</span> conmigo?</h1>
					</div>
				</div>
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="ast_vastu_info">
						<div class="row">
							<div class="col-lg-4 col-md-4 col-sm-12 col-12">
								<ul>
									<li>Observo aquello que vive en ti y que no has podido descifrar, caminos que tu
										consciente no te permite ver con claridad.</li>
								</ul>
							</div>
							<div class="col-lg-4 col-md-4 col-sm-12 col-12">
								<img src="images/content/sesiones.png" alt="About">
							</div>
							<div class="col-lg-4 col-md-4 col-sm-12 col-12">
								<ul>
									<li>Resuelvo tu inquietud, tu busqueda mas profunda, tu necesidad de saber…. <br>
										Esas preguntas que buscan respuestas.</li>
								</ul>
							</div>
						</div>
					</div>
	...
	<!-- Consultas Start -->
	<div class="ast_service_wrapper ast_toppadder70 ast_bottompadder50" id="consultas">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="ast_heading">
						<h1>Tipos de <span>consultas</span></h1>
						<p>Todas mis consultas son privadas y nadie más que yo te atenderá. Te ofrezco sesiones
							personalizadas uno a uno conectando 100% contigo, con tu razón y propósito.</p>
					</div>
				</div>
				<div class="col-lg-6 col-lg-offset-1 col-md-6 col-sm-12 col-12">
					<div class="ast_service_box">
						<img src="images/content/online.png" alt="Service">
						<h4>On line</h4>
						<p>Duración: 1 hora 30 min.</p>
						<div class="clearfix"></div>
						<a href="https://wa.me/+5215515249681?text=Me%20gustaría%20más%20información%20sobre%20tu%20sesión%20en%20línea."
							class="ast_btn"><i class="fab fa-whatsapp"></i> Chatea Ahora</a>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="ast_service_box">
						<img src="images/content/precencial.png" alt="Service">
						<h4>En persona<br><small style="font-size: 0.6em;">(Únicamente en la Cd. De Puebla. Mx)</small>
						</h4>
						<p>Duración: 1 hora 30 min.</p>
						<div class="clearfix"></div>
						<a href="https://wa.me/+5215515249681?text=Me%20gustaría%20agendar%20una%20cita%20presencial."
							class="ast_btn"><i class="fas fa-phone-alt"></i> Agenda Cita</a>
					</div>
				</div>
			</div>
		</div>
	...
	<!-- Horoscopos Start -->
	<div class="ast_horoscope_wrapper  ast_toppadder70 ast_bottompadder40" id="horoscopos">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="ast_heading">
						<h1><span>Horoscopos</span></h1>
						<p>Si has llegado hasta aqui, es momento de dar click en tu horoscopo y descubrir lo que los astros y el universo te quieren decir.</p>
					</div>
				</div>
			...
			s-8.513-3.122-8.651,1.293C13.784,8.236,17.697,7.079,18.631,6.661z" />
							...
							<h4>Aries (Mesh)</h4>
							<p>del 21 de marzo al 19 de abril</p>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6 col-12">
			...
			c0.926-1.668-2.635-10.63-2.635-10.63L24.545,12.646z" />
											<polygon
												points="19.461,24.833 21.12,30.467 21.863,30.591 22.73,25.377 		" />
											<polygon
												points="22.492,30.697 23.236,30.821 26.631,26.027 23.359,25.483 		" />
			...
			c0.388-1.868-5.672-9.369-5.672-9.369L7.279,12.663z" />
											...
											<polygon
												points="10.679,30.508 11.427,30.407 13.244,24.822 9.959,25.273 		" />
			...
			C3.658,6.384,4.014,5.981,4.513,5.913z" />
											<polygon
												points="18.285,16.323 21.464,11.61 16.059,15.582 10.489,11.523 13.785,16.156 16.012,17.21 		" />
										</g>
									</g>
								</svg></span>
							<h4>Géminis (Mithun)</h4>
							<p>del 21 de mayo al 20 de junio</p>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6 col-12">
		...
		C31.867,18.86,31.863,16.492,32,14.824z" />
							...
							<h4>Cáncer (Karka)</h4>
							<p>del 21 de junio al 22 de julio</p>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6 col-12">
					<div class="ast_horoscope_box">
						<a href="https://www.youtube.com/" target="_blank">
							<span><svg version="1.1" xmlns="http://www.w3.org/2000/svg"
									xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="31.611px"
									height="31.611px" viewBox="0 0 31.611 31.611"
									style="enable-background:new 0 0 31.611 31.611;" xml:space="preserve">
									<g>
		...
		c0.542-5.167,2.825-5.079,6.375-3.557C17.293,0.212,18.795,9.217,16.207,12.926z" />
							...
							<h4>Leo (Sinh)</h4>
							<p>del 23 de julio al 22 de agosto</p>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6 col-12">
		...
		c0.377-0.082,0.565,1.216,0.817,2.458C27.188,11.51,26.173,11.165,26.039,11.121z" />
							...
							<h4>Virgo (Kanya)</h4>
							<p>del 23 de agosto al 22 de septiembre</p>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6 col-12">
					<div class="ast_horoscope_box">
						<a href="https://www.youtube.com/" target="_blank">
							<span><svg version="1.1" xmlns="http://www.w3.org/2000/svg"
									xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="30.773px"
									height="30.773px" viewBox="0 0 30.773 30.773"
									style="enable-background:new 0 0 30.773 30.773;" xml:space="preserve">
									<g>
										<g>
			...
			C29.21,11.792,25.636,12.653,24.279,11.794z" />
											<path
												d="M25.374,14.689c-0.067-0.095-0.175-0.152-0.291-0.156c-0.117-0.007-0.229,0.046-0.301,0.134l-4.385,5.26
			c-0.04,0.047-0.061,0.104-0.072,0.159c-0.034-0.009,0.362,3.923,4.721,3.923c4.355,0,3.932-4.377,3.881-4.355L25.374,14.689z
			 M24.64,20.777c-0.896,0-2.542-0.313-3.539-0.521l3.945-4.735l3.146,4.394C27.196,20.255,25.541,20.777,24.64,20.777z" />
							...
							<h4>Libra (Tula)</h4>
							<p>del 23 de septiembre al 22 de octubre</p>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6 col-12">
			...
			s-3.514,0.466-2.635,4.625C2.597,15.782,3.35,16.176,3.708,16.248z" />
							...
							<h4>Escorpio (Vrushchik)</h4>
							<p>del 23 de octubre al 21 de noviembre</p>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6 col-12">
		...
		c0.104-0.015,0.19-0.052,0.268-0.105C25.181,9.056,25.677,9.182,26.19,10.355z" />
							...
							<h4>Sagitario (Dhanu)</h4>
							<p>del 22 de noviembre al 21 de diciembre</p>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6 col-12">
		...
		C31.551,14.284,29.015,11.113,29.452,9.632z" />
							...
							<h4>Capricornio (Makar)</h4>
							<p>del 22 de diciembre al 19 de enero</p>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6 col-12">
					<div class="ast_horoscope_box">
						<a href="https://www.youtube.com/" target="_blank">
							<span><svg version="1.1" xmlns="http://www.w3.org/2000/svg"
									xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="31.895px"
									height="31.895px" viewBox="0 0 31.895 31.895"
									style="enable-background:new 0 0 31.895 31.895;" xml:space="preserve">
									<g>
										<g>
			...
			c0.338,0.094,1.115,0.146,1.156-0.393C18.241,20.452,17.529,20.556,17.283,20.546z" />
							...
							<h4>Acuario (Kumbha)</h4>
							<p>del 20 de enero al 18 de febrero</p>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6 col-12">
					<div class="ast_horoscope_box">
						<a href="https://www.youtube.com/" target="_blank">
							<span><svg version="1.1" xmlns="http://www.w3.org/2000/svg"
									xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="31.998px"
									height="31.998px" viewBox="0 0 31.998 31.998"
									style="enable-background:new 0 0 31.998 31.998;" xml:space="preserve">
									<g>
										<g>
											<path
												d="M29.276,10.111c-0.166-0.34-0.257-0.528-0.257-0.528s2.528,0.58,2.818-0.249c-4.354-4.812-7.685-2.753-8.46-3.318
			...
			c-0.104,0.188-1.36-0.424-1.443-0.651s0.345-0.481,1.009-0.171C11.752,26.314,11.628,26.639,11.523,26.824z" />
							...
							<h4>Piscis (Meen)</h4>
							<p>del 19 de febrero al 20 de marzo</p>
						</a>
					</div>
				</div>
			</div>
	...
	<!-- Cartas Start -->
	<div class="ast_tarot_wrapper ast_toppadder70 ast_bottompadder70" id="las_cartas">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="ast_heading">
						<h1>Las <span>cartas</span></h1>
					</div>
				</div>
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
						...
						<div class="row">
							<div class="col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="ast_tarot_box">
									<a href="#las_cartas">
										<img src="images/content/tarot_01.webp" alt="tarot" title="Tarot Card">
							...
							<div class="col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="ast_tarot_box">
									<a href="#las_cartas">
										<img src="images/content/tarot_02.webp" alt="tarot" title="Tarot Card">
										<div class="terot_content">
											<!--<h3>El Emperador</h3>-->
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
										</div>
							...
							<div class="col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="ast_tarot_box">
									<a href="#las_cartas">
										<img src="images/content/tarot_03.webp" alt="tarot" title="Tarot Card">
										<div class="terot_content">
											<!--<h3>El Emperador</h3>-->
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
										</div>
										<h4>El Rey de Oros</h4>
									</a>
								</div>
							</div>
							<div class="col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="ast_tarot_box">
									<a href="#las_cartas">
										<img src="images/content/tarot_04.webp" alt="tarot" title="Tarot Card">
										<div class="terot_content">
											<!--<h3>El Emperador</h3>-->
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
										</div>
										<h4>El Caballero de Oros</h4>
									</a>
								</div>
							</div>
							<div class="col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="ast_tarot_box">
									<a href="#las_cartas">
										<img src="images/content/tarot_05.webp" alt="tarot" title="Tarot Card">
										<div class="terot_content">
											<!--<h3>El Emperador</h3>-->
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
										</div>
										<h4>El 9 de Espadas</h4>
									</a>
								</div>
							</div>
							<div class="col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="ast_tarot_box">
									<a href="#las_cartas">
										<img src="images/content/tarot_06.webp" alt="tarot" title="Tarot Card">
										<div class="terot_content">
											<!--<h3>El Emperador</h3>-->
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
										</div>
										<h4>La Sota de Espada</h4>
									</a>
								</div>
							</div>
							<div class="col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="ast_tarot_box">
									<a href="#las_cartas">
										<img src="images/content/tarot_07.webp" alt="tarot" title="Tarot Card">
										<div class="terot_content">
											<!--<h3>El Emperador</h3>-->
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
										</div>
										<h4>La Reina de Copas</h4>
									</a>
								</div>
							</div>
							<div class="col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="ast_tarot_box">
									<a href="#las_cartas">
										<img src="images/content/tarot_08.webp" alt="tarot" title="Tarot Card">
										<div class="terot_content">
											<!--<h3>El Emperador</h3>-->
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
										</div>
	...
	<!-- Contacto Start -->
	<div class="ast_journal_wrapper ast_toppadder70 ast_bottompadder70" id="contacto">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="ast_heading">
						<h1><span>Contáctame</span> para más detalles</h1>
						<p>Agenda una cita conmigo.</p>
					</div>
				</div>
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
						...
						<form action="procesar_formulario.php" method="post">
							<div class="row">
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-12">
									...
									<input class="form-control" placeholder="Tu email" type="email" id="email" name="email">
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									<label>Mensaje</label>
									<textarea class="form-control" id="comentarios" name="comentarios" rows="4" cols="50" placeholder="Mensaje"></textarea>
								</div>
								<div class="response"></div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<button class="ast_btn pull-right submitForm" type="submit" form-type="contact" value="Submit" name='submit'><i class="fa fa-paper-plane" aria-hidden="true"></i> Enviar</button>
								</div>
							</div>
						</form>
					</div>
	...
	<!-- Sígueme YouTube Start -->
	<div class="ast_download_wrapper ast_white_wrapper ast_toppadder70 ast_bottompadder70">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="ast_heading">
						<h1><span>Sígueme</span></h1>
						<p>Sígueme y escucha tus predicciones semanales y mensuales.</p>
						<p>Aprende conmigo temas que te ayudarán a mejorar tu vida día a día.</p>
					</div>
				</div>
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="ast_download_box">
						<ul>
							<li><a href="https://www.youtube.com" target="_blank"><img src="images/content/youtube.png" alt="logo youtube" title="Link YouTube"></a></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<!-- Footer Start -->
	<div class="ast_footer_wrapper ast_toppadder50 ast_bottompadder20">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="ast_footer_info">
						<img src="images/header/logo.png" alt="Logo">
						<p>El tarot es un lenguaje, cada carta es una palabra, un sustantivo o un verbo. Al combinar las cartas podemos leer relatos diferentes y concretos.</p>
					</div>
				</div>
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="ast_copyright_wrapper">
						<p>Copyright © <script>document.write(new Date().getFullYear())</script>, All Rights Reserved, <a href="https://magytarot.mx/">Magy Tarot</a></p>
					</div>
				</div>
			</div>
		</div>
